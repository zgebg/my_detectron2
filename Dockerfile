...
RUN pip install ninja yacs cython matplotlib tqdm scipy torchsampler scikit-image opencv-python numpy scikit-learn pillow argparse shapely pandas seaborn simplejson termcolor
